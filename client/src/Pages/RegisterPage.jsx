    ...
    <div className="mt-4 grow flex items-center justify-around">
        <div className="-mt-32">
            ...
            <form action="" className="max-w-md mx-auto" onSubmit={registerUser}>
                <input type="email" placeholder="your@mail.com" value={name} onChange={ev =>setName(ev.target.value)}/>
                <input type="text" placeholder="John Doe" value={email} onChange={ev =>setEmail(ev.target.value)}/>
