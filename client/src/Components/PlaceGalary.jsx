           ...
           <div className="grid gap-2 grid-cols-[2fr_1fr] rounded-3xl overflow-hidden">
                ...
                <div className="grid ">
                  {place.photos?.[1] && (
                        ...
                        src={'http://localhost:4000/uploads/'+place.photos?.[1] } alt="Main picture" />
                    )}
                    <div className="overflow-hidden">
                      {place.photos?.[2] && (
                        <img onClick={() => setshowAllPhotos(true)} className="aspect-square object-cover relative top-2" 
                        src={'http://localhost:4000/uploads/'+place.photos?.[2] } alt="Main picture" />
                      )}
                    </div>     
                </div>
            </div>
