  ...
  return (
    <div >
     ...
     <form onSubmit={savePlace}>
        ...
        <textarea className="my-4" placeholder="place description" value={description} onChange={ev => setDescription(ev.target.value)}/>
        ...
        <textarea className="my-4" placeholder="Optional" value={extraInfo} onChange={ev => setExtraInfo(ev.target.value)}/>
